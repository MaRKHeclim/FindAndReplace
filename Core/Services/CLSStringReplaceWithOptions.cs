...
namespace FindAndReplace.Core.Services
{
    ...
    public class CLSStringReplaceWithOptions : Core.Ports.Incoming.IFCStringReplaceWithOptions
    {
        ...
        public static string fncStringReplaceWithOptions(
                                                string p_vstUSSearchIn,
                                                string p_vstUSFind,
                                                string p_vstUSReplace,
                                                ENMFindMode p_enmFindMode,
                                                bool p_vbnMatchCase = true,
                                                bool p_vbnMatchWholeWord = false,
                                                bool p_vbnDotMatchesNewline = false,
                                                bool p_vbnTreatLinesAsSeparateStrings = true)
        {
        ...
        /// </param>
        /// <returns>The string resulting from performing the find and replace operation.</returns>
        public static string fncRegExReplace(string p_vstUSSearchIn, string p_vstUSFind, string p_vstUSReplace, bool p_vbnMatchCase, bool p_vbnDotMatchesNewline, bool p_vbnTreatLinesAsSeparateStrings)
        {
            string vstResult = string.Empty;
